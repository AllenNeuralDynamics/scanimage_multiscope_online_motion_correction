...
function s = defaultMdfSection()
    s = [...
        most.HasMachineDataFile.makeEntry('positionerNames',{{'' '' ''}},'Positioner names as strings, in the order XYZ. Use empty string if dimension isn''t used (e.g. If only using the z dimensions {'''','''',''Z.Z''})')...
        most.HasMachineDataFile.makeEntry('ipAddress','192.168.0.254')...
        most.HasMachineDataFile.makeEntry('port',5001)...
        most.HasMachineDataFile.makeEntry('acceleration',[1E3 1E3 40E3],'um per s')...
        most.HasMachineDataFile.makeEntry('velocity',[.4E3 .4E3 5E3],'um per s')...
        most.HasMachineDataFile.makeEntry('minJerkRaw',[.005 .005 .005],'device units')...
        most.HasMachineDataFile.makeEntry('maxJerkRaw',[.005 .005 .005],'device units')...
        most.HasMachineDataFile.makeEntry('invertCoordinates',[0 0 0])...
        ];
end
