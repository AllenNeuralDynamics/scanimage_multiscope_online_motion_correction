...
%                 return;
    ...
    methods (Hidden)
        ...
        function tf = isValidName(obj,name)
            ...
            tf = tf && ~isempty(regexpi(name,'^[-9a-z\x7f-\xff -]+[0-9a-z\x7f-\xff -_]*$','match','once')); %\x7f-\xff allows some special characters e.g. German Umlaute
        end
    end
...
function supportedVersions = getSupportedVersions(build)
    ...
    hPathChanger = most.util.PathChanger(binfolder);
