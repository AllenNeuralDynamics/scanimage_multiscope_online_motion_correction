classdef D < dabs.resources.IO
    properties
        supportsHardwareTiming = false;
    end
    
    methods
        function obj = D(name,hDAQ)
    ...
    methods
        function set.supportsHardwareTiming(obj,val)
            validateattributes(val,{'numeric','logical'},{'scalar','binary'});
            obj.supportsHardwareTiming = logical(val);
        end
    end
end
