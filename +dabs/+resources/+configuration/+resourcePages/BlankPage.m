classdef BlankPage < dabs.resources.configuration.ResourcePage
    methods
        function obj = BlankPage(hResource,hParent)
        ...
        function makePanel(obj,hParent)
            ...
            uicontrol('Parent',hFlowMiddle,'Style','text','String','Nothing to configure.','HorizontalAlignment','center','FontWeight','bold');
        end
