classdef ScientificaPmtControllerPage < dabs.resources.configuration.ResourcePage
    properties
        pmhCOM
        tableAutoOn
    end
    ...
    methods
        function obj = ScientificaPmtControllerPage(hResource,hParent)
