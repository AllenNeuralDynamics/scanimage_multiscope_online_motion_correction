classdef GalvoAnalogPage < dabs.resources.configuration.ResourcePage
    ...
    methods
        ...
        function makePanel(obj,hParent)
            ...
            most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [25 51 170 20],'Tag','txVoltsPerDistance','String','Volts per optical degree','HorizontalAlignment','right');
            obj.etVoltsPerDistance = most.gui.uicontrol('Parent',hParent,'Style','edit','RelPosition', [200 49 120 20],'Tag','etVoltsPerDistance');
            most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [25 75 170 20],'Tag','txTravelRange1','String','Angular range [optical degrees]','HorizontalAlignment','right');
            obj.etAngularRange = most.gui.uicontrol('Parent',hParent,'Style','edit','RelPosition', [200 72 120 20],'Tag','etAngularRange');
            most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [25 97 170 20],'Tag','txParkPosition','String','Park position [optical degrees]','HorizontalAlignment','right');
            obj.etParkPosition = most.gui.uicontrol('Parent',hParent,'Style','edit','RelPosition', [200 95 120 20],'Tag','etParkPosition');
            most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [24 120 170 20],'Tag','txSlewRateLimit','String','Slew rate limit (vDAQ only) [V/s]','HorizontalAlignment','right');
            obj.etSlewRateLimit = most.gui.uicontrol('Parent',hParent,'Style','edit','RelPosition', [200 118 120 20],'Tag','etSlewRateLimit');
            
            most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [25 158 170 20],'Tag','txhAIFeedback','String','Feedback Channel (optional)','HorizontalAlignment','right');
            obj.pmhAIFeedback = most.gui.uicontrol('Parent',hParent,'Style','popupmenu','String',{''},'RelPosition', [199 157 120 20],'Tag','pmhAIFeedback');
