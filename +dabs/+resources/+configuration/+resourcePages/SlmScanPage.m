    ...
    methods
        ...
        function makePanel(obj,hParent)
            ...
            hTab = uitab('Parent',hTabGroup,'Title','Basic');
                ...
                obj.etFocalLength_mm = most.gui.uicontrol('Parent',hTab,'Style','edit','RelPosition', [160 112 130 20],'Tag','etFocalLength_mm');
                hlp = sprintf('Effective focal length of the SLM imaging system.\nf ... effective focal length of the SLM system\nf_o ... focal length of the objective\nM_so ... Magnification of the SLM onto the objective back aperture\nf = f_o / M_so');
