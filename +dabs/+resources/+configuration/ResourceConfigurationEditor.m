classdef ResourceConfigurationEditor < most.util.Singleton
    ...
    methods
        ...
        function initialize(obj)
            ...
            obj.hButtonFlow = most.gui.uiflowcontainer('Parent',obj.hLeftFlow,'FlowDirection','TopDown','margin',0.1);
        ...
        function redrawProtected(obj)
            ...
            function makeResourceButtons(hResources)
                ...
                % recreate buttons
                obj.hButtonFlow.Parent = obj.hTabGroup.SelectedTab;
            ...
            function makeAddButton(addType)
                ...
                hAddButton = most.gui.uicontrol( ...
                    ...
                    ,'Tooltip',most.idioms.ifthenelse(isScan2D, 'Add Imaging System', 'Add device') ...
                    ,'HeightLimits',[15 30]);
