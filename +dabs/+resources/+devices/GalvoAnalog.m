classdef GalvoAnalog < dabs.resources.devices.LinearScanner & dabs.resources.widget.HasWidget
    properties (SetAccess=protected)
        WidgetClass = 'dabs.resources.widget.widgets.GalvoWidget';
    end
    
    methods
        function obj = GalvoAnalog(name)
