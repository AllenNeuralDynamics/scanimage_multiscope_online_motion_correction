classdef SystemTimer < handle
    ...
    methods
        function obj = SystemTimer()
            ...
            obj.hTimers(end+1) = timer('ExecutionMode','fixedSpacing','Period',0.667,'Name','System Timer 15Hz', 'TimerFcn',@(varargin)obj.notify('beacon_15Hz'));
            obj.hTimers(end+1) = timer('ExecutionMode','fixedSpacing','Period',0.333,'Name','System Timer 30Hz', 'TimerFcn',@(varargin)obj.notify('beacon_30Hz'));
