classdef paramCellArrayEdit < handle
    ...
    properties (Hidden)
        ...
        delChar = ['<html><table border=0 width=24><TR><TD><center>' most.constants.Unicode.ballot_x '</center></TD></TR></table></html>'];
        keyDown = false;
    end
    ...
    methods (Hidden)
        ...
        function openEditPanel(obj,varargin)
            ...
            if most.idioms.isValidObj(obj.hFig)
                ...
                sz = [300 150];
                obj.hFig = most.idioms.figure('numbertitle','off','name','Edit Parameters','menubar','none','units','pixels',...
