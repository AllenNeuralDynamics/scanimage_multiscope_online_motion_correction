function Answer=inputdlgCentered(Prompt, Title, NumLines, DefAns, Resize)
% exactly the same as builtin inputdlg, but centers dialog on monitor instead
% over current callback figure
...
%%%%%%%%%%%%%%%%%%%% FIX FOR CENTERED FIGURE DISPLAY %%%%%%%%%%%%%%%%%%%%
%set(InputFig,'Position',getnicedialoglocation(FigPos,get(InputFig,'Units')));
InputFig.Position(3:4) = FigPos(3:4);
most.gui.centerOnScreen(InputFig);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
