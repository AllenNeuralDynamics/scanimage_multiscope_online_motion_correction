classdef DClass < hgsetget
    ...
    methods(Access=protected)
        function displaySmart(obj,propList,varargin)
            ...
            disp(['Package: ' mClass.ContainingPackage.Name most.constants.Unicode.new_line]);
            ...
            if ~argStruct.suppressInheritedProps
                ...
                for super=[inheritedProps.keys]
                    if argStruct.explicitInheritanceDisplayEnable
                        disp([most.constants.Unicode.new_line 'Inherited from <a href = "matlab:help ' super{1} '">' super{1} '</a>:']);
            ...
            disp([most.constants.Unicode.new_line '<a href = "matlab:methods(''' mClass.Name ''')">Methods</a>, ' ...
