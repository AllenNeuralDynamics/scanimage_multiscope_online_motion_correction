...
%                 z = z - midPoint + pi;
    ...
    methods (Access = private)
        function initUserInterface(obj,visible)
            ...
            obj.hFig = most.idioms.figure('NumberTitle','off','Name','Zernike Generator',...
        ...
        function initMainAxes(obj,Parent)
            obj.hAx = most.idioms.axes('Parent',Parent);
            obj.hIm = imagesc(obj.hAx,'CData',nan(4));
            axis(obj.hAx,'off');
            box(obj.hAx,'on');
        ...
        function hAx = makeZAxes(obj,p)
            hAx = most.idioms.axes('Parent',obj.hFig,'Color','none','CLim',[0 2*pi]);
            [n,m] = obj.nollIndexToDegree(p);
            z = obj.zernike(n,m);
            axis(hAx,'off');
            grid(hAx,'off');
        ...
        function initZaxes(obj,Parent)
            obj.hAxPreview = most.idioms.axes('Parent',Parent,'Color','none');
