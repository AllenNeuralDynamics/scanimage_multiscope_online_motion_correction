classdef FrameScanDataView < scanimage.guis.ScanImageDataView
    ...
    methods
        function obj = FrameScanDataView(filename)
            obj.hFig = most.idioms.figure('numbertitle','off','name','ScanImage Data View','menubar','none','units','pixels',...
            ...
            %% Plot axes
            obj.hPlotAxes = most.idioms.axes('parent',obj.hFig,'Color','None','box','on','xgrid','on','ygrid','on','xcolor','w','ycolor','w',...
            ...
            obj.hPlotVLblAxes = most.idioms.axes('parent',obj.hFig,'Color','none','xcolor','none','ycolor','none','xlim',[0 1],'ylim',[0 1],'Hittest','off');
            ...
            obj.hPlotHLblAxes = most.idioms.axes('parent',obj.hFig,'Color','none','xcolor','none','ycolor','none','xlim',[0 1],'ylim',[0 1],'Hittest','off');
            ...
            obj.hFovMouseFindAxes = most.idioms.axes('parent',obj.hFovPanel,'color','none','XColor','none','YColor','none','position',[0 0 1 1],'hittest','off');
            obj.hFovAxes = most.idioms.axes('parent',obj.hFovPanel,'Color','None','xcolor','none','ycolor','none','Zcolor','none','DataAspectRatio',[1 1 1],'UIContextMenu',obj.hFovContextMenu);
            ...
            obj.hZSelAxes = most.idioms.axes('parent',hZpnl,'Color','None','xcolor','none','ycolor','none','position',[0 0 1 1],'xlim',[0 90],'ylim',[0 1],'ydir','reverse','ButtonDownFcn',@obj.hitZSlider);
            ...
            %% Time axes
            obj.hTimeAxes = most.idioms.axes('parent',obj.hFig,'Color','None','xcolor','none','ycolor','none','xlim',[0 1],'ylim',[0 1],'Hittest','off');
            ...
            %% display cfg
            g = 4;
            obj.hCfgFig = most.idioms.figure('numbertitle','off','name','View Properties','menubar','none','units','pixels',...
    ...
    methods
        ...
        function loadData(obj,filename)
            ...
            if isempty(roiGroup)
                ...
                sf.pixelResolutionXY = [header.SI.hRoiManager.pixelsPerLine header.SI.hRoiManager.linesPerFrame];
...
%             obj.addPlotPt(i/obj.scanPathN);
    ...
    methods (Hidden)
        ...
        function updatePlotAxes(obj)
            ...
            exps = {'' 'm' most.constants.Unicode.micro_sign 'n'};
        ...
        function exportPlot(obj,varargin)
            N = numel(obj.hPlotLines);
            if N
                f = most.idioms.figure();
                a = most.idioms.axes('parent',f);
                
                hold(a,'on');
                for i = 1:N
                    lines(i) = plot(a,obj.hPlotLines(i).XData*obj.timeExponent, obj.hPlotLines(i).YData);
                end
                
                legend(a,lines,obj.getPlotNames(false));
