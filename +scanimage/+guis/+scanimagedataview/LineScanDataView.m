classdef LineScanDataView < scanimage.guis.ScanImageDataView
    ...
    methods
        function obj = LineScanDataView(filename,debug)
            ...
            obj.hFovAxes = most.idioms.axes('parent',obj.hFovPanel,'Color','None','xcolor','none','ycolor','none','DataAspectRatio',[1 1 1],'YDir','reverse','ZDir','reverse','UIContextMenu',obj.hFovContextMenu);
            ...
            %% Time axes
            obj.hTimeAxes = most.idioms.axes('parent',obj.hFig,'Color','None','xcolor','none','ycolor','none','xlim',[0 1],'ylim',[0 1],'Hittest','off','UIContextMenu',obj.hDelAllTimePtsContextMenu);
    ...
    methods
        ...
        function loadData(obj,filename)
            ...
            for idx = 1:numel(obj.scannerSet.beams)
                obj.scannerSet.beams(idx).sampleRateHz = Fsc;
            end

            for idx = 1:numel(obj.scannerSet.fastz)
                obj.scannerSet.fastz(idx).sampleRateHz = Fsc;
            end
    ...
    methods (Hidden)
        ...
        function exportPlot(obj,varargin)
            ...
            if N
                ...
                legend(a,lines,obj.getPlotNames());
