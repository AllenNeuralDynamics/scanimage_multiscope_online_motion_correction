    ...
    methods
        ...
        function init(obj)
            if ~most.idioms.isValidObj(obj.hFig)
                obj.hFig = most.idioms.figure('numbertitle','off','name','Render Frame Sequence','menubar','none','units',...
            ...
            if ~most.idioms.isValidObj(obj.hRenderFig)
                obj.hRenderFig = most.idioms.figure('numbertitle','off','name','Render Preview','menubar','none','units','pixels','Color','k',...
                    'position',[0 0 600 600],'CloseRequestFcn',@obj.hideRenderFig,'visible','off','SizeChangedFcn',@obj.resizeRenderWindow);
                
                obj.hFovAxes = most.idioms.axes('parent',obj.hRenderFig,'Color','None','xcolor','none','ycolor','none','Zcolor','none','DataAspectRatio',[1 1 1],'hittest','off');
