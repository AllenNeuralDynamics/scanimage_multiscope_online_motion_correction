    ...
    methods
        ...
        function populateTabs(obj,hParent)
            ...
            function populateBoundedPanel()
                ...
                most.gui.uicontrol('Parent',hTab,'String','etStackStart','style','edit','Bindings',{obj.hModel.hStackManager 'stackZStartPos' 'value' '%.2f'},'Tag','etStackStart','RelPosition', [67 132 40 20],'Enable','off');
                most.gui.uicontrol('Parent',hTab,'String','etStackStartPower','style','edit','Bindings',{obj.hModel.hStackManager 'stackStartPowerFraction' 'value' '%.2f' 'scaling' 100},'Tag','etStackStartPower','RelPosition', [110 132 70 20],'Enable','off');
                ...
                most.gui.uicontrol('Parent',hTab,'String','etStackEnd','style','edit','Bindings',{obj.hModel.hStackManager 'stackZEndPos' 'value' '%.2f'},'Tag','etStackEnd','RelPosition', [67 155 40 20],'Enable','off');
                most.gui.uicontrol('Parent',hTab,'String','etStackEndPower','style','edit','Bindings',{obj.hModel.hStackManager 'stackEndPowerFraction' 'value' '%.2f' 'scaling' 100},'Tag','etStackEndPower','RelPosition', [110 155 70 20],'Enable','off');
