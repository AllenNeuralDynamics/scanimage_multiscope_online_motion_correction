classdef LaserTriggerScope < most.Gui
        ...
        function obj = LaserTriggerScope(hSI,~)
            ...
            f = most.gui.uiflowcontainer('Parent',obj.hFig,'FlowDirection','LeftToRight','margin',0.00001);
                pf = most.gui.uiflowcontainer('Parent',f,'FlowDirection','TopDown','margin',0.00001);
                    obj.hDigAxes = most.idioms.axes('Parent',pf,'Box','on','XGrid','on','XMinorGrid','on','ylim',[-.25 1.25],'ytick',[0 1],'YTickLabel',{'L' 'H'},'XTickLabel',[]);
                    ...
                    obj.hAxes = most.idioms.axes('Parent',pf,'Box','on','XGrid','on','YGrid','on','XMinorGrid','on','ylim',obj.ylim);
            ...
            obj.hISLis = most.ErrorHandler.addCatchingListener(obj.hSI, 'imagingSystem','PostSet',@obj.setImgSys);
            obj.setImgSys();
    ...
    methods (Hidden)
        ...
        function updateWindowDisp(obj)
            obj.hMaskSurf.XData = repmat(obj.wndDelay + [0 obj.wndWidth],2,1) - .5;
            obj.hMaskDLine.XData = repmat(obj.wndDelay,1,2) - .5;
            obj.hMaskLLine.XData = repmat(obj.wndDelay + obj.wndWidth,1,2) - .5;
            obj.hMaskArrL.XData(1:2) = [0 obj.wndDelay - .5];
            obj.hMaskArrH.XData(1) = obj.wndDelay - .5;
            ...
            if isempty(obj.triggerNominalPeriodTicks)
                ...
                obj.hMaskSurf2.XData = repmat(obj.wndDelay + [0 obj.wndWidth] - obj.triggerNominalPeriodTicks,2,1) - .5;
                obj.hMaskDLine2.XData = repmat(obj.wndDelay - obj.triggerNominalPeriodTicks,1,2) - .5;
                obj.hMaskLLine2.XData = repmat(obj.wndDelay + obj.wndWidth - obj.triggerNominalPeriodTicks,1,2) - .5;
                obj.hMaskArrL.XData(4:5) = [0 obj.wndDelay]-obj.triggerNominalPeriodTicks - .5;
                obj.hMaskArrH.XData(3) = obj.wndDelay-obj.triggerNominalPeriodTicks - .5;
            end
        end
        ...
        function setImgSys(obj,varargin)
            ...
            if obj.hSI.hScan2D.laserTriggerFilterSupport
                ...
                obj.initmode = true;
                obj.enableSampleMask = obj.hSI.hScan2D.laserTriggerSampleMaskEnable;
                obj.samplingWindow = obj.hSI.hScan2D.laserTriggerSampleWindow;
        ...
        function set.traceLength(obj,v)
            if most.idioms.isValidObj(obj.hDataScope)
                try
                    ...
                    v = double(min(v,obj.hDataScope.hFifo.fifoActualDepth));
                end
            end
            obj.traceLength = v;
