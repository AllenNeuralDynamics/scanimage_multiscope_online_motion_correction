classdef NI5771Sampler < handle    
    ...
    methods
        function obj = NI5771Sampler(hFpga,hScan2D)
            ...
            obj.hFpga.channelsInvert = obj.hScan.channelsInvert;
            ...
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hSIChannel1,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hSIChannel2,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hSIChannel3,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hSIChannel4,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hPhotonDiscriminatorChannel0,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            obj.hListeners = [obj.hListeners most.ErrorHandler.addCatchingListener(obj.hPhotonDiscriminatorChannel1,'configurationChanged',@(varargin)notify(obj,'configurationChanged'))];
            ...
            function prepareHistogram()
                ...
                obj.hFigHist = most.idioms.figure('MenuBar','none','NumberTitle','off','Name','Photon Timing Histogram','Visible','off','CloseRequestFcn',@disablePhotonHistogram);
                obj.hAxHistChannel0 = most.idioms.subplot(2,1,1,'Parent',obj.hFigHist);
                obj.hAxHistChannel1 = most.idioms.subplot(2,1,2,'Parent',obj.hFigHist);
                obj.hBarHistChannel0 = bar(obj.hAxHistChannel0,0:15,zeros(1,16),'BarWidth',1,'LineStyle','none','FaceColor',most.constants.Colors.vidrioBlue);
                obj.hBarHistChannel1 = bar(obj.hAxHistChannel1,0:15,zeros(1,16),'BarWidth',1,'LineStyle','none','FaceColor',most.constants.Colors.vidrioBlue);
