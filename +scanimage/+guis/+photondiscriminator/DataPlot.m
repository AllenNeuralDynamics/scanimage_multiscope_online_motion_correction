classdef DataPlot < most.gui.GuiElement
    ...
    methods
        ...
        function init(obj)
            ...
            obj.hAxRaw = most.idioms.axes('Parent',obj.hUIPanel,'ButtonDownFcn',@obj.axisButtonDownFcn,'Box','on','XTickLabel','');
            grid(obj.hAxRaw,'on');
            ...
            obj.hAxProcessed = most.idioms.axes('Parent',obj.hUIPanel,'ButtonDownFcn',@obj.axisButtonDownFcn,'Box','on','XTickLabel','');
            ...
            obj.hAxBrush = most.idioms.axes('Parent',obj.hUIPanel,'ButtonDownFcn',@obj.axisButtonDownFcn,'Box','on','XTickLabel','','YTickLabel','');
        ...
        function updateBrush(obj,brushWindow)
            ...
            if length(xTicks) > 1
                ...
                tickSpacingTime = tickSpacing / obj.hPhotonDiscriminator.hSampler.hFpga.rawSampleRateAcq;
