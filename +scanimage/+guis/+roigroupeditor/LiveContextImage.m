classdef LiveContextImage < scanimage.guis.roigroupeditor.ContextImageProvider
    ...
    methods
        ...
        function v = setChannelIdx(obj,v)
            ...
            o = obj.selectedChannelIsScanner || obj.selectedChannelIsScannerMerge;
            ...
            if obj.visible
                if (o && ~obj.scannerRoisActive) || (~o && obj.scannerRoisActive)
                    obj.show();
                end
        ...
        function updateScannerImageFromVar(obj,srcVar,channelIdx)
            if isempty(obj.hDisplay.(srcVar)) || isempty(obj.hDisplay.(srcVar){obj.currZIdx})
                return;
            end
