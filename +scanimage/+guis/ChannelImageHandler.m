...
% channel images, merge, etc out of SI core.)
    ...
    methods
        ...
        function obj = ChannelImageHandler(hChanTbl)
            assert(isa(hChanTbl,'scanimage.guis.ChannelTable'));
            
            obj.hChannelControlsCAT = hChanTbl;
        ...
        function updateTable(obj,prettyColorMapSpec)
            ...
            if strcmp(prettyColorMapSpec,'Custom')
                obj.hChannelControlsCAT.setColormapEditability(true);
            else
                ...
                obj.hChannelControlsCAT.setColormaps(clrMapVals);
                
                % update column editable-ness
                obj.hChannelControlsCAT.setColormapEditability(false);
            end
        end
        ...
        function applyTableColorMapsToImageFigs(obj)
            ...
            colorMapFcns = obj.hChannelControlsCAT.getColormaps();
