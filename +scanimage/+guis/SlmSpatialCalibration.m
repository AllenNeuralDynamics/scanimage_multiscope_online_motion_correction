    ...
    methods
        ...
        function [T,zs] = startCalibration(obj)
            ...
            if obj.imageUsingFastZ
                fastZInitialPosition_ = obj.hModel.hFastZ.positionTarget;
            else
                fastZInitialPosition_ = 0;
            end
            
            if obj.moveWithFastZ
                motorStartZ = obj.hModel.hFastZ.positionTarget;
            else
            ...
            try
                ...
                for zIdx = 1:size(gridPts,3)
                    ...
                    for ptIdx = 1:size(gridPts,1)
                        ...
                        if obj.moveWithFastZ
                            obj.hModel.hFastZ.positionTarget = motorStartZ - z;
                        else
                            if obj.imageUsingFastZ
                                obj.hModel.hFastZ.positionTarget = fastZInitialPosition_;
                            else
                                obj.hModel.hMotors.moveSample([NaN, NaN, motorStartZ-z]);
                            end
                        end
                        ...
                        if obj.moveWithFastZ
                            obj.hModel.hFastZ.positionTarget = motorStartZ;
                        else
                            if obj.imageUsingFastZ
                                obj.hModel.hFastZ.positionTarget = fastZInitialPosition_ + z;
                            else
    ...
    methods (Access = private)
        ...
        function centroids = processImages(obj)
            ...
            for idx = 1:size(stackd,3)
                ...
                assert(any(im(:)),'Could not find burn mark in image');
