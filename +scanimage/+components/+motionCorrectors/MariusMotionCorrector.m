...
classdef MariusMotionCorrector < scanimage.interfaces.IMotionCorrector    
    properties (SetObservable)
        runningAverageLength_s = 1;     % running average length in seconds for motion correction value
        correctionInterval_s = 2;      % interval for motion correction events in secondes
        correctionThreshold = [0.1 0.1 1]; % units are in [degrees degrees micron]
