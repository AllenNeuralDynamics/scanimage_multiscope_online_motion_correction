    ...
    methods
        ...
        function applyTriggerConfig(obj)            
            ...
            if most.idioms.isValidObj(obj.hScan.hResonantScanner)
                ...
                obj.hFpgaAE.acqParamPeriodTriggerMaxPeriod = min(2^16-1,round(1.05*obj.hFpga.nominalDataClkRate/resScanFreq));
                obj.hFpgaAE.acqParamPeriodTriggerMinPeriod = min(2^16-1,round(0.95*obj.hFpga.nominalDataClkRate/resScanFreq));
