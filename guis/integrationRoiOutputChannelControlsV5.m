...
% Last Modified by GUIDE v2.5 27-Feb-2018 13:45:44
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.changeIntegrationRoiOutputChannelRoiSelection('all');


% --- Executes on button press in pbSelectNone.
function pbSelectNone_Callback(hObject, eventdata, handles)
% hObject    handle to pbSelectNone (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.changeIntegrationRoiOutputChannelRoiSelection('none')
