...
function mnu_View_BeamControls_Callback(hObject, eventdata, handles)
handles.hController.showGUI('BeamControls');
...
function mnu_Help_Legal_Callback(hObject, eventdata, handles)
scanimage.guis.Legal();
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.hAlignmentControls.raise();
...
% --------------------------------------------------------------------
function mnu_View_WidgetBar_Callback(hObject, eventdata, handles)
% hObject    handle to mnu_View_StatusWindow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
hWidgetBar = handles.hController.hWidgetBar;
hWidgetBar.Visible = true;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.hMotionDisplay.showGui();
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.hWaveformControls.Visible = true;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.hDataScope.showGui();

function mnu_File_OpenTiff_Callback(hObject, eventdata, handles)
% hObject    handle to mnu_File_Config (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
sidataview();

function mnu_File_OpenLineScan_Callback(hObject, eventdata, handles)
% hObject    handle to mnu_File_Config (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
sidataview();
