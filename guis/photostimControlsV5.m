...
% Last Modified by GUIDE v2.5 26-Apr-2018 16:16:21
...
function etMotionCorrectionVector_Callback(hObject, eventdata, handles)
% hObject    handle to etMotionCorrectionVector (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of etMotionCorrectionVector as text
%        str2double(get(hObject,'String')) returns contents of etMotionCorrectionVector as a double


% --- Executes during object creation, after setting all properties.
function etMotionCorrectionVector_CreateFcn(hObject, eventdata, handles)
% hObject    handle to etMotionCorrectionVector (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
