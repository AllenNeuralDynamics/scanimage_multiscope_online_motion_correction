...
% Last Modified by GUIDE v2.5 15-Nov-2020 21:15:29
...
% --- Executes on button press in cbCenterSlm.
function cbCenterSlm_Callback(hObject, eventdata, handles)
% hObject    handle to cbCenterSlm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.updateModel(hObject,eventdata,handles);
